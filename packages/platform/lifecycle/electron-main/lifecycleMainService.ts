...
import { ICodeWindow, LoadReason, UnloadReason } from 'platform/window/electron-main/window';
...
export interface ILifecycleMainService {
   ...
   */
  reload(window: ICodeWindow): Promise<void>;
...
export class LifecycleMainService extends Disposable implements ILifecycleMainService {
  ...
  async reload(window: ICodeWindow): Promise<void> {
