...
import { Client as IPCElectronClient } from 'base/parts/ipc/electron-sandbox/ipc.electron';
import { IMainProcessService } from 'platform/ipc/electron-sandbox/services';
